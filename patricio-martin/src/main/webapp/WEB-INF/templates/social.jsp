...
<div class="" style="max-width:200px;margin:0 auto !important;">
<nav class="level is-flex">
  <p class="level-item has-text-centered">
    <a href="#0" class="link is-info c-link c-link--facebook c-tooltip" aria-label="Facebook"><svg class="c-icon"><use xlink:href="#icon--facebook"></use></svg></a>
  </p>
  <p class="level-item has-text-centered">
    <a href="#0" class="link is-info c-link c-link--twitter c-tooltip" aria-label="Twitter"><svg class="c-icon"><use xlink:href="#icon--twitter"></use></svg></a>
  </p>
  <p class="level-item has-text-centered">
    <a href="#0" class="c-link c-link--instagram c-tooltip" aria-label="Instagram"> <svg class="c-icon"><use xlink:href="#icon--instagram"></use></svg></a>
  </p>
  <p class="level-item has-text-centered">
    <a href="#0" class="link is-info c-link c-link--pinterest c-tooltip" aria-label="Pinterest"><svg class="c-icon"><use xlink:href="#icon--pinterest"></use></svg></a>
  </p>
</nav>
</div>
...
<!-- </a>  <svg class="c-icon"><use xlink:href="#icon--google"></use></svg>-->
