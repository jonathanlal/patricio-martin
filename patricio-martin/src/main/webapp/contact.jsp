			...
			<div class="column" style="padding-bottom:0 !important;">
				<div class="field">
					<div class="control has-icons-left">
						<input id="fname" class="input is-success" type="text" placeholder="Full Name">
			    		<span class="icon is-small is-left"><i class="fas fa-user"></i></span>
			  		</div>
				</div>
				<div class="field">
					<div class="control has-icons-left">
			    		<input id="femail" class="input is-danger" type="email" placeholder="Email Address">
			    		<span class="icon is-small is-left"><i class="fas fa-envelope"></i></span>
			  		</div>
				</div>
				<div class="field has-addons">
					<div class="control" style="    max-width: 130px;">
			    		<span class="select" id="fphonecode">
			      			<select>
			  
    <option data-countryCode="ES" value="34" Selected>(+34) España</option>
          	  <option data-countryCode="GB" value="44">(+44) UK</option>
    
    <optgroup label="Other countries">
        <option data-countryCode="AL" value="Albenia (+355)">Albenia (+355)</option>
...
<!-- 			       		<span class="icon is-small is-left"><i class="fas fa-envelope"></i></span> -->
			 		...
			 		<div class="control is-expanded"><input id="fphone" class="input" type="text"  placeholder="Phone Number"></div>
				</div>
			</div>
			<div class="column">
				<div class="field">
					<div class="control"><textarea id="fmessage" class="textarea is-link" placeholder="Message"></textarea></div>
				</div>
			</div>
		</div>
		<div class="field" style="float: right;">
		<div class="control"><button class="button is-success is-small" id="fbtn">Send</button></div>
		</div>
		   </div>   
	</div>
	</div>
