	 ...
	 public static Connection getConnection(String db_schema_name){
		 ...
		 try{
			 if (SystemProperty.environment.value() == SystemProperty.Environment.Value.Production) {
				 ...
				 Class.forName("com.mysql.cj.jdbc.Driver"); //don't need to specify this apparently
				 url = "jdbc:mysql://"+Globals.DB_LOCALHOST+"/"+db_schema_name+"?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
			 }
